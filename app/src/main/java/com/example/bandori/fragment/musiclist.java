...
import com.example.bandori.HomePage;
import com.example.bandori.R;
import com.example.bandori.adapter.music_list;
...
public class musiclist extends Fragment {
    ...
    public musiclist(USERBandori user){
        this.user=user;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ArrayList<MUSICBandori> musics = db.musicRead(null,null);
        ListView musicList = (ListView) view.findViewById(R.id.music_listview);
        music_list music_list_adapter = new music_list(musics,user,getContext());
        musicList.setAdapter(music_list_adapter);
    }
